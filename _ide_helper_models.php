 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits query()
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits whereCompanyId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Benifits whereUpdatedAt($value)
 */
	class Benifits extends \Eloquent {}
}
 ...
 * @property int|null $profile_complate
 ...
 * @property-read \App\Models\Profession|null $professions
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Candidate whereProfileComplate($value)
 ...
 * @property-read \App\Models\City|null $cities
 * @property-read \App\Models\Country|null $countries
 * @property-read \App\Models\IndustryType|null $industries
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Job> $jobs
 * @property-read int|null $jobs_count
 * @property-read \App\Models\OrganizationType|null $organizations
 * @property-read \App\Models\State|null $states
 * @property-read \App\Models\TeamSize|null $teamSizes
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\AppliedJob> $application
 * @property-read int|null $application_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\JobBenifits> $benefits
 ...
 * @property int $id
 * @property int $job_id
 * @property int $benifit_id
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \App\Models\Benifits|null $benefit
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits query()
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits whereBenifitId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits whereJobId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|JobBenifits whereUpdatedAt($value)
 */
	class JobBenifits extends \Eloquent {}
}
