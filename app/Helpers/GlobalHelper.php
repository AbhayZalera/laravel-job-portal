...
if (!function_exists('hasError')) {
    ...
    {
        return $errors->has($name) ? 'is-invalid' : ''; // return empty string if no error
    }
}
...
// check company profile completition
...
// check Candidate profile completition
