            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.industry-type.create') }}" class="btn btn-primary"><i
                                ...
                                <tbody>
                                    @forelse ($industryTypes as $type)
                                        <tr>
                                            <td>{{ $type->name }}</td>
                                            <td>{{ $type->slug }}</td>
                                            <td><a href="{{ route('admin.industry-type.edit', $type->id) }}"
                                                    class="btn btn-small btn-primary"><i class="fas fa-edit"></i></a>
                                                <a href="{{ route('admin.industry-type.destroy', $type->id) }}"
