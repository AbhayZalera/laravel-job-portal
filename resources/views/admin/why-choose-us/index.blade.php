                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ hasError($errors, 'sub_title_one') }}"
                                                name="sub_title_one"
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ hasError($errors, 'sub_title_two') }}"
                                                name="sub_title_two"
                                                value="{{ old('sub_title_two', $whyChooseUs?->title_two) }}">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ hasError($errors, 'sub_title_three') }}"
