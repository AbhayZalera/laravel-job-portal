<form action="{{ route('candidate.profile.basic-info-update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-3">
            <x-image-preview :height="200" :width="300" :source="$candidate?->image" />
            ...
            {{-- <x-image-preview :height="200" :width="300" :source="" /> --}}
            <div class="form-group">
                <label class="font-sm color-text-mutted mb-10">CV
                    * <span class="text-info">({{ $candidate?->cv ? 'Have attached CV' : '' }})</span></label>
                <input class="form-control {{ $errors->has('cv') ? 'is-invalid' : '' }}" type="file" value=""
                    name="cv">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control datepicker {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}"
