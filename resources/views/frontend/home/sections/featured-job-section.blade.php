                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-5"><span
                                                    ...
                                                    class="card-time"><span>
                                                        {{ $job->created_at->diffForHumans() }}</span></span>
                                            </div>
                                            <div class="mt-20">
                                            ...
                                            <div class="mt-20">
                                                @foreach ($job->skills as $jobSkill)
                                                    @if ($loop->index <= 6)
                                                        <a class="btn btn-grey-small mr-5 mt-5"
                                            ...
                                            @if ($job->salary_mode === 'range')
                                                <span class="card-text-price">{{ $job->min_salary }} -
                                                    {{ $job->max_salary }}
                                                    {{ config('settings.site_default_currency') }}</b> </span>
                                            @else
                                                <span class="card-text-price">{{ $job->custom_salary }}</b> </span>
                                            @endif
                                        </div>
