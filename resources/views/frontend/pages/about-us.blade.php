            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="font-sm color-text-paragraph wow animate__animated animate__fadeInUp w-lg-50 mx-auto">
                        {{ config('settings.site_name') }} is more than just a job board; it's a dynamic hub connecting
                        talented individuals with their dream careers and empowering businesses to unlock their full
                        potential. We bridge the gap between job seekers and employers, making the recruitment process
                        smooth, efficient, and accessible for everyone.</p>
                </div>
