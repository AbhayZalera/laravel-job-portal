                                    ...
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <p class="mt-10 color-text-paragraph font-sm">
                                                {{-- {!! Str::limit($blog->description, $limit = 150, $end = '...') !!} --}}
                                                {{ Str::limit(strip_tags($blog->description), $limit = 150, $end = '...') }}
                                            </p>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                        ...
                        <div class="sidebar-shadow sidebar-news-small">
                            ...
                            <div class="post-list-small">
                                ...
                                @forelse ($featureds as $blog)
                                    <div class="post-list-small-item d-flex align-items-center">
                                        <figure class="thumb mr-15"><img src="{{ $blog->image }}" alt="joblist">
                                        </figure>
                                        <div class="content">
